...
CREATE TABLE `booking` (
  ...
  `go_date` date NOT NULL COMMENT 'go_date',
  `time` varchar(255) NOT NULL COMMENT 'morning or afternoon',
  `price` int NOT NULL COMMENT 'Price',
  `member_id` bigint NOT NULL COMMENT 'member_id',
  `create_date` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_booking` (`member_id`),
  KEY `attraction_id` (`attraction_id`),
  CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`attraction_id`) REFERENCES `attraction` (`id`),
  CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
...
-- Dump completed on 2025-04-10 14:22:22
